...
class PersistencePolicy(object):
    ...
    """
    def __init__(self, event_store, event_type):
...
class TimestampedEntityPersistencePolicy(object):
    ...
    def __init__(self, event_store):
        assert isinstance(event_store, AbstractEventStore)
        self.event_store = event_store
        subscribe(self.store_event, self.is_timestamped_entity_event)
    ...
    def close(self):
        unsubscribe(self.store_event, self.is_timestamped_entity_event)
