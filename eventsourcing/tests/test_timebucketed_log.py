...
class TestLogWithCassandra(WithCassandraActiveRecordStrategies, TimebucketedlogTestCase):
    pass


class TestLogWithSQLAlchemy(WithSQLAlchemyActiveRecordStrategies, TimebucketedlogTestCase):
    pass
