...
from eventsourcing.infrastructure.cassandra.activerecords import CqlIntegerSequencedItem, CqlSnapshot, \
    CqlTimestampSequencedItem
...
class CassandraDatastoreTestCase(AbstractDatastoreTestCase):
    ...
    def construct_datastore(self):
        return CassandraDatastore(
            ...
            tables=(CqlIntegerSequencedItem, CqlTimestampSequencedItem, CqlSnapshot),
        )
