...
from eventsourcing.example.application import ExampleApplication, NewExampleApplication
...
from eventsourcing.infrastructure.eventstore import AbstractEventStore, AbstractStoredEventRepository, \
    AbstractSequencedItemRepository
...
class NewExampleApplicationTestCase(AbstractStoredEventRepositoryTestCase):
