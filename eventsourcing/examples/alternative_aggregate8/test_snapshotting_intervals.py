...
from eventsourcing.examples.alternative_aggregate8.application import DogSchool
from eventsourcing.examples.alternative_aggregate8.domainmodel import Dog
