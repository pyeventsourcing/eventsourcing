...
Add the Python `eventsourcing` package to your project. Run `uv init` to start a new project.
    ...
    uv add "eventsourcing[pydantic,postgres,umadb]~=10.0.0a7"

Alternatively, install directly into a Python virtual environment from the [Python Package Index](https://pypi.org/project/eventsourcing/10.0.0a7/).
