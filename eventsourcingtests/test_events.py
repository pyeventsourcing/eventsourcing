...
class TestEvents(unittest.TestCase):
    ...
    def test_event_attributes(self):
        ...
        self.assertEqual(3, Example.Created(entity_id='entity1', a=1, b=2, uuid=3).uuid)
        uuid = uuid1().hex
        self.assertEqual(timestamp_from_uuid(uuid), Example.Created(entity_id='entity1', a=1, b=2, uuid=uuid).timestamp)
    ...
    def test_hash(self):
        event1 = Example.Created(entity_id='entity1', a=1, b=2, uuid=3)
        event2 = Example.Created(entity_id='entity1', a=1, b=2, uuid=3)
        self.assertEqual(hash(event1), hash(event2))

    def test_equality_comparison(self):
        event1 = Example.Created(entity_id='entity1', a=1, b=2, uuid=3)
        event2 = Example.Created(entity_id='entity1', a=1, b=2, uuid=3)
        event3 = Example.Created(entity_id='entity1', a=3, b=2, uuid=3)
    ...
    def test_repr(self):
        event1 = Example.Created(entity_id='entity1', a=1, b=2, uuid=3)
        self.assertEqual("Example.Created(a=1, b=2, entity_id='entity1', entity_version=0, uuid=3)", repr(event1))
