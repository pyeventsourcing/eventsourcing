...
from eventsourcing.infrastructure import stored_events_sqlalchemy
...
from eventsourcing.infrastructure.stored_events_sqlalchemy import SQLAlchemyStoredEventRepository, get_scoped_session_facade
