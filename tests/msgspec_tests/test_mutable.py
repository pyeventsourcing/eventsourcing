...
#     def test(self) -> None:
#         self.assertIs(MsgspecAggregate.originator_id_type, UUID)
#         self.assertIs(MsgspecAggregate.Event.originator_id_type, UUID)
#         self.assertIs(MsgspecAggregate.Created.originator_id_type, UUID)
#         self.assertIs(MsgspecAggregate.Snapshot.originator_id_type, UUID)
#
#         class WithStrID(MsgspecAggregate[str]):
#             pass
#
...
#         self.assertTrue(issubclass(MsgspecAggregate.Snapshot, CanSnapshotAggregate))
#         self.assertFalse(issubclass(MsgspecAggregate.Snapshot, CanMutateAggregate))
#
#
...
#
#
# class MutableAggregateWithUuidIDAndEventClasses(MsgspecAggregate[UUID]):
#     class Snapshot(MsgspecAggregate.Snapshot[UUID]):
#         state: SnapshotStateWithA
#
#     class Started(MsgspecAggregate.Created[UUID]):
#         a: int
#
#     class Reset(MsgspecAggregate.Event[UUID]):
#         a: int
#
#     class Unused(MsgspecAggregate.Event[UUID]):
#         a: int
#
#     @event(Started)
...
#
#
# class MutableAggregateWithUuidIDAndEventNames(MsgspecAggregate[UUID]):
#     class Snapshot(MsgspecAggregate.Snapshot[UUID]):
#         state: SnapshotStateWithA
#
#     @event("Started")
...
#
#
# class MutableAggregateWithStrIDAndEventClasses(MsgspecAggregate[str]):
#     class Snapshot(MsgspecAggregate.Snapshot[str]):
#         state: SnapshotStateWithA
#
#     class Started(MsgspecAggregate.Created[str]):
#         a: int
#
#     class Reset(MsgspecAggregate.Event[str]):
#         a: int
#
#     class Unused(MsgspecAggregate.Event[str]):
#         a: int
#
#     @event(Started)
#     def __init__(self, a: int) -> None:
...
#
#
# class MutableAggregateWithStrIDAndEventNames(MsgspecAggregate[str]):
#     class Snapshot(MsgspecAggregate.Snapshot[str]):
#         state: SnapshotStateWithA
#
#     @event("Started")
...
#
#         copy = snapshot_copy.mutate(object.__new__(self.cls_under_test))
