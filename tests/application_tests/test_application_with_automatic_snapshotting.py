...
class BankAccountsWithAutomaticSnapshotting(BankAccountsWithPydantic):
    is_snapshotting_enabled = False
    snapshotting_intervals: ClassVar[dict[type[Any], int]] = {
        BankAccountWithPydantic: 5
    }
...
class TestApplicationWithAutomaticSnapshotting(TestCase):
    ...
    #     class MyAggregate1(PydanticAggregate):
    ...
    #         snapshot_class = AggregateSnapshot
    #
