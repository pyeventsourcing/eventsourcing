...
#             pass
#
#         self.assertFalse("__dataclass_fields__" in MyAggregateWithoutDecorator.__dict_
#         _)
#
...
#         a = MyAggregate()
#         created_event = a._pending_events[0]
#         self.assertIs(type(created_event), MyAggregate.Started)  # type: ignore[attr-d
#         efined]
#         self.assertTrue(
...
#     #     self.assertTrue(
#     #         msg.endswith(
#     #             "MyAgg.ValueUpdated.apply(). Values returned from 'apply' methods ar
#     e"
#     #             " discarded."
#     #         ),
#     #         msg,
...
#         # Open an account.
#         account: BankAccountWithPydantic = BankAccountWithPydantic.open(
#             full_name="Alice",
...
#             C(a=1, c="c")
#
#         self.assertIn("missing 1 required positional argument: 'b'",
#         str(cm.exception))
#
