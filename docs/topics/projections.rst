...
.. code:: python
    ...
    original = WithSQLAlchemy(persist_event_type=AggregateRoot.Event)

    # Construct replica application.
    replica = WithSQLAlchemy()
...
.. code:: python
    ...
    # Construct original application.
    original = WithSQLAlchemy(persist_event_type=User.Event)

    # Construct index application.
    index = WithSQLAlchemy(persist_event_type=IndexItem.Event)
