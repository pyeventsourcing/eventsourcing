...
tested with a sequence of commands replicated from a production system, by verifying
the application state generated by the new version matches the production version.
